...
# ALIASES - EDITORS
# ============================================================================
# Launch gedit in background (detached from terminal)
note() { nohup gedit "$@" >/dev/null 2>&1 & }
...
# ALIASES - DOCKER
# ============================================================================
alias dockup='sudo systemctl start docker && echo "Docker started"'
alias dockdown='sudo systemctl stop docker && echo "Docker stopped"'
alias dockstatus='systemctl is-active docker && docker ps'
alias dockprune='docker system prune -af && echo "Docker cleaned up"'
alias dps='docker ps'
